...
function weblinkComponentAutoload($class)
{
...
class WeblinkcomponentAutoloader
{
	public static function autoload($class)
	{
		weblinkComponentAutoload($class);
	}
}

spl_autoload_register(array(' weblinkcomponentautoloader','autoload'));