    ...
    export default {
        ...
        methods: {
            ...
            unselectAllBrowserItems(event) {
                ...
                const clickedToggle = (event.target.id !== undefined && event.target.id === 'toggle-all-items');
                ...
                const clickedOutside = notClickedBrowserItems && notClickedInfobar && !clickedDelete && !clickedToggle;
                if (clickedOutside) {
