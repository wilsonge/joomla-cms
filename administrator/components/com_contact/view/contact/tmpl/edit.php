...
<form action="<?php echo JRoute::_('index.php?option=com_contact&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="contact-form" class="form-validate">
	...
	<?php echo JLayoutHelper::render('joomla.edit.title_alias', array('form' => $this->form)); ?>
	...
	<div class="form-horizontal">
		...
		<div class="row-fluid">
			...
			<div class="span3">
				<?php echo JLayoutHelper::render('joomla.edit.global', array('form' => $this->form)); ?>
			</div>
		</div>
		...
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo JLayoutHelper::render('joomla.edit.publishingdata', array('form' => $this->form)); ?>
			</div>
			<div class="span6">
				<?php echo JLayoutHelper::render('joomla.edit.metadata', array('form' => $this->form)); ?>
			</div>
		</div>
		<?php echo JHtml::_('bootstrap.endTab'); ?>
