 ...
 * @since  3.5
 */
class ComponentRouterViewconfiguration
{
	/**
	 * Name of the view
	 *
	 ...
	 *
	 * @var    ComponentRouterViewconfiguration
	 * @since  3.5
	 */
	public $parent = false;
	 ...
	 * @param   string  $name  Name of the view
	 *
	 * @return  ComponentRouterViewconfiguration  This object for chaining
	 *
	 * @since   3.5
	 */
	 ...
	 *
	 * @param   ComponentRouterViewconfiguration  $parent      Parent view object
	 ...
	 * @since   3.5
	 */
	public function setParent(ComponentRouterViewconfiguration $parent, $parent_key = false)
	{
		if ($this->parent)
		{
