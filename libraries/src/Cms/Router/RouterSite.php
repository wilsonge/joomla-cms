...
class RouterSite extends Router
{
	 ...
	 * @param   ApplicationCms  $app      ApplicationCms Object
	 * @param   Menu            $menu     JMenu object
	 *
	 * @since   3.4
	 */
	public function __construct($options = array(), ApplicationCms $app = null, Menu $menu = null)
	{
		parent::__construct($options);

		$this->app  = $app ? $app : ApplicationCms::getInstance('site');
