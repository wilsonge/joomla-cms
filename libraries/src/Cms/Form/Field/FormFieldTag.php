...
use Joomla\Cms\Helper\HelperTags;
use JFactory;
 ...
 * @since  3.1
 */
class FormFieldTag extends JFormFieldList
{
	/**
	...
	protected function getInput()
	{
		...
		{
			if ($this->value instanceof HelperTags)
			{
	...
	protected function getOptions()
	{
		...
		{
			$options = HelperTags::convertPathsToNames($options);
		}
