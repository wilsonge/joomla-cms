 ...
 * @subpackage  com_contact
 */
class ContactControllerContactSubmit extends JControllerCms
{
	public function execute()
	{
		...
		{
			$sent = $this->sendEmail($data, $contact, $params->get('show_email_copy'));
		}
	...
	private function sendEmail($data, $contact, $copy_email_activated)
	{
			$app		= $this->app;
